...
AskUserQuestion([
  {
    ...
    multiSelect: false,
    options: [
      { label: "Quality", description: "gpt-5.2-codex everywhere (highest cost)" },
      { label: "Balanced (Recommended)", description: "gpt-5.2-codex for planning, gpt-5.1-codex(-mini) elsewhere" },
      { label: "Budget", description: "gpt-5.1-codex-mini for most tasks (lowest cost)" }
    ]
  },
  {

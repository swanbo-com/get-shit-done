...
| Profile | Description |
|---------|-------------|
| **quality** | gpt-5.2-codex everywhere (highest quality) |
| **balanced** | gpt-5.2-codex for planning, gpt-5.1-codex(-mini) elsewhere (default) |
| **budget** | gpt-5.1-codex-mini for most tasks (lowest cost) |
</profiles>
